...
var _a;
autoDiscoveryPaths.cvr = { version: "2.4.22", path: curScriptDir };
...
CaptureVisionRouterModule._version = `${"2.4.22"}(Worker: ${(_a = innerVersions.cvr) === null || _a === void 0 ? void 0 : _a.worker}, Wasm: loading...`;
    ...
    static async createInstance() {
        ...
        mapTaskCallBack[taskID] = async (body) => {
            ...
            if (body.success) {
                ...
                CaptureVisionRouterModule._version = `${"2.4.22"}(Worker: ${(_a = innerVersions.cvr) === null || _a === void 0 ? void 0 : _a.worker}, Wasm: ${body.version})`;
